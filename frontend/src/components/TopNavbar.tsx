...
export const TopNavbar = () => {
    ...
    return (
        <div className="fq-navbar" style={{ padding: '0 24px', height: '60px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', gap: '40px', alignItems: 'center', height: '100%' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }} onClick={() => window.location.href = '/dashboard'}>
                    <div style={{ width: '24px', height: '24px', background: 'var(--fq-gold)', borderRadius: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', color: '#000', fontSize: '14px' }}>F</div>
                        ...
                        return (
                            <a 
                                ...
                                style={{ 
                                    ...
                                    height: '100%',
                                    padding: '0 4px',
                                    borderBottom: isActive ? '3px solid var(--fq-gold)' : '3px solid transparent',
            ...
            <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                <div 
                    ...
                    onMouseEnter={(e) => {
                        e.currentTarget.style.borderColor = 'var(--fq-gold)';
                        e.currentTarget.style.background = 'var(--fq-gold)';
                        e.currentTarget.style.color = '#000';
                    }}
                    onMouseLeave={(e) => {
                        e.currentTarget.style.borderColor = 'var(--border)';
                        e.currentTarget.style.background = '#1a1a1a';
                        e.currentTarget.style.color = 'var(--fq-gold)';
                    }}
                    title="Sign Out"
                >
                    Q
